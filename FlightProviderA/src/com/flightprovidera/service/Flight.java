...
/**
 * SOAP Body – uçuş bilgisi.
 */
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "Flight", namespace = "http://service.flightprovider.com/",
        propOrder = {"flightNo", "origin", "destination", "departuredatetime", "arrivaldatetime", "price"})
public class Flight {
